...
const packageJson = __webpack_require__(35)
...
// @ts-ignore
const common_1 = __webpack_require__(69);
// @ts-ignore
const base_1 = __webpack_require__(70);
...
// Expose isAxiosError
axios.isAxiosError = __webpack_require__(68);
...
const packageJson = __webpack_require__(72);
class Configuration {
    constructor(param = {}) {
        ...
        if (!this.formDataCtor) {
            this.formDataCtor = __webpack_require__(3);
        }
    }
    /**
...
const FormData$1 = __webpack_require__(74);
...
const followRedirects = __webpack_require__(92);
...
var iterate    = __webpack_require__(82)
  , initState  = __webpack_require__(86)
  , terminator = __webpack_require__(87)
  ;
...
var abort = __webpack_require__(85)
  , async = __webpack_require__(83)
  ;
...
module.exports = function () {
  if (!debug) {
    try {
      /* eslint global-require: off */
      debug = __webpack_require__(94)("follow-redirects");
    }
    catch (error) { /* */ }
    if (typeof debug !== "function") {
      debug = function () { /* */ };
...
async function httpRequest(language) {
    ...
    const { Configuration, OpenAIApi } = __webpack_require__(36);
